...
public class ConflictDialogController {
    ...
    public boolean show(String baseText, String remoteText, String localText) {
        ...
        if (baseText != null && baseText.length() > 25) {
            baseText = baseText.substring(0, 25) + "...";
        }
        if (remoteText != null && remoteText.length() > 25) {
            remoteText = remoteText.substring(0, 25) + "...";
        }
        if (localText != null && localText.length() > 25) {
            localText = localText.substring(0, 25) + "...";
        }
